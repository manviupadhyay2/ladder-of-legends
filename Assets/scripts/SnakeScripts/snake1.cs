...
public class Snake1 : MonoBehaviour
{
    ...
    {
        while (currentlyFollowingPlayer == playerScript && IsPlayerInRange(playerScript))
        {
            ...
            while (Vector3.Distance(tracker1.transform.position, targetPosition) > 0.1f)
            {
                ...
                managerSnakes.animator[0].SetBool("SnakeMove", true);
    ...
    public void KillPlayer(PlayerScript currentPlayerScript)
    {
        ...
        int positionToMove = 1 + (18 - playerPosition);
    ...
    {
        int numSteps = playerScript.numberOfStepsAlreadyMoved;
        return (numSteps >= 11 && numSteps <= 18);
    }
    ...
    public void setSnakeSpeed()
    {
        ...
        Debug.Log("Snake's Speed is :: " + followSpeed);
    }
